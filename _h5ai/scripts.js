...
function(t) {
    ...
    if (!t || t.window !== t || !t.document)
        throw new Error("no-window");
    var r = "no-browser",
        i = t.document.documentElement;
    i.className = "", e("console", t.console &&
        n(t.console.log)), e(
        "assign", t.Object && n(t.Object
            .assign)), e("promise",
        n(t.Promise)), e("xhr", t.XMLHttpRequest)
}(this),
function(t) {
    function e(r) {
        ...
        return t[r].call(i.exports, i,
                i.exports, e), i.loaded = !
            0, i.exports
    }
    var n = {};
    return e.m = t, e.c = n, e.p = "",
        e(0)
}([function(t, e, n) {
    "use strict";
    n(1)
    ...
    var r = n(2),
        ...
        E = function(t) {
            var e = A(t, 20, 80),
                ...
                "!important;",
                a =
                "#view.view-details.view-size-" +
                t,
                s =
                "#view.view-grid.view-size-" +
                t,
                u =
                "#view.view-icons.view-size-" +
                t,
                c = [a +
        ...
        I = function(t) {
            ...
            return e.addCls(t.isFolder() ?
                ...
                (e.addCls(
                    ...
                    t.icon = d.icon(
                        "folder-page"
                    )), t.isCurrentParentFolder() &&
                (t.icon = d.icon(
                        "folder-parent"
                    ), b.setParentFolderLabels ||
                    i.addCls(
                        "l10n-parentDirectory"
                    ), e.addCls(
                        "folder-parent"
                    )), r.attr(
                    "src", t.icon
    ...
    var r = n(2),
        ...
        l =
        '<div class="cm-panel"><ul></ul></div>',
        f =
        '<li class="cm-sep"></li>',
        d =
        '<li class="cm-entry"><span class="cm-icon"><img/></span><span class="cm-text"></span></li>',
        h =
        '<li class="cm-label"><span class="cm-text"></span></li>',
        p = function(t) {
            for (; !t._cmId &&
                t.parentNode;) t =
                t.parentNode;
    ...
    var r = n(2),
        ...
        p = void 0,
        g = function(t) {
            h = t.slice(0), h.length ?
                p.show() : f.alwaysVisible ||
                p.hide()
        },
        v = function() {
            var t = f.type,
    ...
    (function(t) {
        ...
        var e = n(33),
            ...
            _ = function(n) {
                var r = n.thumbRational ||
                    n.icon,
                    o = !!n
                    .thumbRational;
                if (!n.isCurrentFolder() &&
                    r || (r =
                        u.icon(
                            "folder"
                        )),
            ...
            N = function() {
                p.enabled &&
                    (a(g).hide()
                        ...
                        a(
                            "#pv-bar-prev, #pv-prev-area"
                        ).on(
                            "click",
                            M
                        ),
                        a(
                            "#pv-bar-next, #pv-next-area"
                        ).on(
                            "click",
                            E
                        ),
    ...
    (function(t) {
        ...
        var e = "function" ==
            ...
            h =
            '<pre id="pv-content-txt"></pre>',
            p =
            '<div id="pv-content-txt"></div>',
            g = function() {
                var t = s(
                    "#pv-content-txt"
                )[0];
        ...
        var e = n(2),
            ...
            T = function t(
                ...
                f.off(
                        ...
                        t),
                    _(e), i(
                        "#items .item.selecting.selected"
                    ).rmCls(
                        "selecting"
                    ).rmCls(
                        "selected"
                    ), i(
                        "#items .item.selecting"
                    ).rmCls(
                        "selecting"
                    ).addCls(
                        "selected"
